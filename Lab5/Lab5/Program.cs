...
namespace Lab5
{
    internal class Program
    {
        static void Main()
        {
            ...
            Regex openTag = new Regex(@"<node\d>");  //Паттерн для поиска открывающих тегов любого уровня
            Regex closeTag = new Regex(@"</node\d>"); //Паттерн для поиска закрывающих тегов любого уровня
